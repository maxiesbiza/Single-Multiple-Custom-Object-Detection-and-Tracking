...
while True:
 ...
 # run non-maxima suppresion
	...
	for track in tracker.tracks:
		...
		cv2.line(img, (0, int(3*height/6+ height/20)), (width, int(3*height/6+ height/20)), (0, 255, 0), thickness=2) #line in the middle of the screen

		#Count in a specific area
		cv2.line(img, (0, int(3*height/6 - height/20)), (width, int(3*height/6 - height/20)), (0, 255, 0), thickness=2) #line
	...
	cv2.putText(img, "Contador vehiculos en area: " + str(current_count), (0,80), 0, 1, (0,0,255), 2)
