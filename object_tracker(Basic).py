...
model_filename = 'model_data/mars-small128.pb' #pretrainer cnn for tracking pedestrians
encoder = gdet.create_box_encoder(model_filename, batch_size=1)
metric = nn_matching.NearestNeighborDistanceMetric('cosine', max_cosine_distance, nn_budget)
tracker = Tracker(metric)

vid = cv2.VideoCapture('/content/Single-Multiple-Custom-Object-Detection-and-Tracking/data/video/test.mp4')
